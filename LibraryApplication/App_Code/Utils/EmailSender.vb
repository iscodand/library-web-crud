...
Public Class EmailSender
    Public Sub Send(ByVal subject As String, ByVal user As User, Optional ByVal token As Token = Nothing, Optional templatePath As String = "")
        Try
            ...
            mailBody = mailBody.Replace("[[user.FullName]]", user.FullName)
            mailBody = mailBody.Replace("[[token.Token]]", token.Token)
            email.Body = mailBody
